...
base="../../../Desktop/risultati/Tesi/confronto_2_dimensioni/"
cartella = "../../../Desktop/risultati/Tesi/confronto_2_dimensioni/MVGA/Fronte_di_Pareto"  
cartella_NSGA = "../../../Desktop/risultati/Tesi/confronto_2_dimensioni/NSGAII/Fronte_di_Pareto"  # Modifica con il percorso della tua cartella
grafici = cartella[:-17]
color_ga ="#ff5757"
color_mixed ="#004aad"
...
for number in range(0, 24):
    plot_pareto_fronts_non_normalized(F_non_norm[number], F_non_norm_nsga[number], "MVGA", "NSGAII", (t+number))
    plot_pareto_fronts(F_non_norm[number], F_non_norm_nsga[number], "MVGA", "NSGAII", (t+number), MVGA_min[number], NSGA_min[number])
...
with freeze_time(datetime.now().replace(hour=t, minute=0, second=0, microsecond=0)) as frozen_datetime:
    ...
    # plot_time(3200.3548707962036,3009.723348140717)
    # plt.tight_layout()
